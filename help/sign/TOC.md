...
+ Erste Schritte {#getting-started}
   ...
   + Send {#getting-started-sending}
      ...
      + [Dokument an einer Unterzeichnerin bzw. einem Unterzeichner senden](sign-beginner-tutorials/send-to-single-recipient.md)
      ...
      + [Erforderliche Auswahlen durch Kontrollkästchengruppen führen](sign-beginner-tutorials/checkbox-groups.md)
      + [Wann eignet sich die Option Kopie erstellen?](sign-beginner-tutorials/create-a-copy.md)
...
+ Erweiterte Aufgaben {#advanced-tasks}
   ...
   + Send {#advanced-tasks-sending}
      + [Signierreihenfolge einrichten](sign-advanced-users/setting-up-routing.md)
      ...
      + [Benutzerdefinierten Workflow erstellen](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
...
+ Verwaltung {#admin-set-up}
   ...
   + Erste Schritte {#getting-started-admin}
      ...
      + [Automatische Benutzerzuweisungsregeln aktivieren](admin/automatic-assignment-rules.md)
      ...
      + [Berichterstattung und Transaktionsnutzung](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
      ...
      + [Benutzerdefinierten Workflow erstellen](admin/building-a-custom-workflow.md)
      ...
      + [Konfigurieren und Steuern der Option &quot;Vereinbarung ändern&quot;](admin/configure-modify-agreement.md)
...
+ Mobile Endgeräte {#mobile}
   ...
   + Tutorials für Mobilgeräte {#mobile-tutorials}
      ...
      + [Mobilfreundliche Ansicht](mobile/mobile-friendly.md)
      + [Mobile-optimierte Ansicht erstellen](mobile/create-mobile-friendly.md)
