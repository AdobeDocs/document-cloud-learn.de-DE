...
+ KI-gestützt {#ai-powered}
  ...
  + [Was ist Acrobat Studio?](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/basics/acrobat-studio)
...
+ Analyzer in Acrobat Studio {#analyzer}
  ...
  + [Erweiterte Funktionen kennenlernen](analyzer/advanced.md)
...
+ Anwendungsfälle {#use-cases}
  ...
  + Geschäftsbereich {#lob}
    ...
    + Marketing {#marketing}
      + [Überblick](use-cases/lob/marketing/marketing-overview.md)
      + [Produkteinführungen mit Acrobat Studio beschleunigen](use-cases/lob/marketing/marketing-product-launch.md)
    + Verkauf {#sales}
  ...
  + Regierungseinrichtungen {#gov}
    ...
    + 5 Tipps für Produktivität an jedem Ort mit Acrobat {#tips}
      + [5 Tipps für die Arbeit an jedem Ort mit Acrobat](use-cases/gov/5-tips-for-working-anywhere-with-acrobat-dc-for-government.md)
      + [Tipp #1 - Tools herunterladen](use-cases/gov/get-your-tools.md)
      + [Tipp #2 - Zusammenarbeit an Dokumenten](use-cases/gov/collaborate-on-documents.md)
      + [Tipp #3: Digitale Protect-Dokumente.](use-cases/gov/protect-digital-documents.md)
      + [Tipp #4 - Arbeiten Sie mit Formularen und Signaturen](use-cases/gov/work-with-forms-and-signatures.md)
